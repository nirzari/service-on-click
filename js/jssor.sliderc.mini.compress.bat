...
SET RESERVE_MEMBERNAMES3=%RESERVE_MEMBERNAMES3%,$JssorEasing$,$JssorSlider$,$JssorNavigator$,$JssorDirectionNavigator$,$JssorThumbnailNavigator$,$JssorCaptionSlider$
